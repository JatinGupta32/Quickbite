...
import com.fooddelivery.quickbite.repository.OrderRepostitory;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse createOrderWithPayment(OrderRequest request) throws RazorpayException {
        ...
        newOrder = orderRepostitory.save(newOrder);
    ...
    public void verifyPayment(Map<String, String> paymentData, String status) {
        ...
        OrderEntity existingOrder = orderRepostitory.findByRazorpayOrderId(razorpayOrderId)
                .orElseThrow(()->new RuntimeException("Order not found"));
        existingOrder.setPaymentStatus(status);
        existingOrder.setRazorpaySignature(paymentData.get("razorpay_signature"));
        existingOrder.setRazorpayPaymentId(paymentData.get("razorpay_payment_id"));
        orderRepostitory.save(existingOrder);
    ...
    public List<OrderResponse> getUserOrders() {
        String loggedInUserId = userService.findByUserId();
        List<OrderEntity> list = orderRepostitory.findByUserId(loggedInUserId);
    ...
    public List<OrderResponse> getOrdersOfAllUsers() {
        List<OrderEntity> list = orderRepostitory.findAll();
        return list.stream().map(entity -> convertToResponse(entity)).collect(Collectors.toList());
    }

    @Override
    public void updateOrderStatus(String orderId, String status) {
        OrderEntity order = orderRepostitory.findById(orderId)
                .orElseThrow(()->new RuntimeException("Order not found"));
