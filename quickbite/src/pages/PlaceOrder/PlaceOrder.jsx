        ...
        <main>
          ...
          <div className="row g-5">
            <div className="col-md-5 col-lg-4 order-md-last">
              <h4 className="summary-title d-flex justify-content-between align-items-center mb-3">
                <span className="text-primary">Your cart</span>
                <span className="badge bg-primary rounded-pill">
                  {cartItems.length}
                </span>
              </h4>
              <ul className="list-group mb-3 checkout-summary">
                {cartItems.map((item) => (
                  <li
                    key={item.id}
            ...
            <div className="col-md-7 col-lg-8">
              <h4 className="billing-title mb-4">Billing Details</h4>
              <form className="needs-validation" onSubmit={onSubmitHandler}>
                ...
                <button
                  className="w-100 checkout-btn btn-lg"
                  type="submit"
